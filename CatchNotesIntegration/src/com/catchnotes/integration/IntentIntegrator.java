...
public class IntentIntegrator {
    ...
    public void viewNotes(String stream, String text, ArrayList<String> tags) {
        // Verify that correct version of notes is installed
        if (!isNotesInstalled()) {
            return;
        }
        ...
        if (stream != null) {
            intent.putExtra(CatchIntent.EXTRA_VIEW_FILTER_STREAM, stream);
        }

        if (text != null) {
            intent.putExtra(CatchIntent.EXTRA_VIEW_FILTER, text);
        }

        if (tags != null) {
            intent.putExtra(CatchIntent.EXTRA_VIEW_FILTER_TAGS, tags);
        }
